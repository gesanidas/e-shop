...
$paintID = $_GET['id'];
$query = mysqli_query($con, "DELETE FROM painting WHERE id=$paintID");
?>
  ...
  <body>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="login-section-heading">
            <h3>Επιτυχης Διαγραφη Πινακα</h3>
            <p>Επιτυχής <strong>διαγραφή</strong> πινακα. Θα ανακατευθυνθείς σε λίγο πίσω...</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="login-section-heading">
            <h3>Μη Επιτυχης Διαγραφη Πινακα</h3>
