...
$painterID = $_GET['id'];
$query = mysqli_query($con, "SELECT * FROM painter WHERE id='$painterID'");
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="add-section-heading">
            <h3>Αλλαγη Ζωγραφου</h3>
            <?php echo '<form action="changepainter.php?id='.$painterID.'" method="post">'; ?>
            <label>Όνομα :</label><?php echo '<input type="text" name="name" value="'.$row['name'].'"/>'; ?><br/><br/>
            <label>Συντομο Βιογραφικο :</label><?php echo '<textarea rows="3" name="bio">'.$row['bio'].'</textarea>'; ?><br/><br/> 
