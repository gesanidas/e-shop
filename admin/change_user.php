      ...
      <div class="row">
        <div class="col-md-12">
          <div class="add-section-heading">
            <h3>Αλλαγη Χρηστη</h3>
            <?php echo '<form action="changeuser.php?id='.$userID.'" method="post">'; ?>
            <label>Όνομα :</label><?php echo '<input type="text" name="name" value="'.$row['name'].'"/>'; ?><br/><br/>
            <label>Email :</label><?php echo '<input type="email" name="email" value="'.$row['email'].'"/>'; ?><br/><br/> 
            ...
            <label>Ρόλος :</label><?php echo '<input type="text" name="role" value="'.$row['role'].'"/>'; ?><br/><br/>  
