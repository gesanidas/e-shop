...
$query = mysqli_query($con, "INSERT INTO painter(name,bio) 
	                         VALUES('$name','$bio');"); 
  ...
  <body>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="login-section-heading">
            <h3>Επιτυχης Προσθηκη Ζωγραφου</h3>
            <p>Επιτυχής <strong>προσθηκη</strong> ζωγραφου. Θα ανακατευθυνθείς σε λίγο πίσω...</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="login-section-heading">
            <h3>Μη Επιτυχης Προσθηκη Ζωγραφου</h3>
