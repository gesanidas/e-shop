...
$paintID = $_GET['id'];
$query = mysqli_query($con, "DELETE FROM painter WHERE id=$paintID");
?>
  ...
  <body>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="login-section-heading">
            <h3>Επιτυχης Διαγραφη Ζωγραφου</h3>
            <p>Επιτυχής <strong>διαγραφή</strong> ζωγράφου. Θα ανακατευθυνθείς σε λίγο πίσω...</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="login-section-heading">
            <h3>Μη Επιτυχης Διαγραφη Ζωγραφου</h3>
